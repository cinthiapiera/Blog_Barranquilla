  ...
  return (
    <aside className="py-[28px] px-[20px]">
        ...
        <article className="border-b-2 py-7 last:border-none">
            <h2 className="text-SoftRed text-[32px] mb-3 font-bold">Comparte</h2>
            {/* <p className="text-[15px]"> tus experiencias y recomendaciones sobre Barranquilla con nuestra comunidad.</p> */}
        </article>
    </aside>
  )
}